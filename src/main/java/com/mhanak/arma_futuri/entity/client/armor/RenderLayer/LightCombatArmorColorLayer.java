...
public class LightCombatArmorColorLayer extends GeoRenderLayer<LightCombatArmorItem> {
    private static final Identifier TEXTURE = ArmaFuturiMod.path("textures/item/armor/light_combat_armor_overlay.png");
    private LightCombatArmorRenderer sneakyArmorRenderer;

    public LightCombatArmorColorLayer(LightCombatArmorRenderer armorRenderer) {
        super(armorRenderer);
    ...
    @Override
    public void render(MatrixStack poseStack, LightCombatArmorItem animatable, BakedGeoModel bakedModel, RenderLayer renderType, VertexConsumerProvider bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
